 ...
 */
function anu_default_approve_user_message() {
	...
	$message = apply_filters( 'approve_approve_new_user_message_default', $message );
 ...
 */
function anu_default_deny_user_message() {
	$message = __( 'You have been denied access to {sitename}.', 'approve-new-user' );

	$message = apply_filters( 'approve_new_user_deny_user_message_default', $message );
 ...
 */
function anu_default_registration_complete_message() {
	...
	$message = apply_filters( 'approve_new_user_pending_message_default', $message );

	return $message;
}

function anu_auto_approve_message() {
	...
	', 'approve-new-user' ) );
	$message .= ' ';
	$message = apply_filters( 'approve_new_user_auto_approve_message', $message );
 ...
 */
function anu_default_welcome_message() {
	...
	$welcome = apply_filters( 'approve_new_user_welcome_message_default', $welcome );
 ...
 */
function anu_default_notification_message() {
	...
	$message = apply_filters( 'approve_new_user_notification_message_default', $message );
 ...
 * has been taken.
 */
function anu_default_registration_message() {
	...
	$message = apply_filters( 'approve_new_user_registration_message_default', $message );

	return $message;
}

function anu_default_registeration_welcome_email() {
