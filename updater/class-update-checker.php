<?php
if (!class_exists('ANUIWP_Update_Checker')) {

    class ANUIWP_Update_Checker {
        ...
        public function __construct() {
            $utility = anuiwp_updater_utility();
        ...
        public function check_for_updates($transient) {
            ...
            $transient_name = 'anuiwp_plugin_updates';
